...
P.brake.low_speed_takeover_time_s = 0.015;
P.brake.stop_hold_entry_speed_mps = 0.10;
P.brake.hold_deceleration_mps2 = 0.30;
...
metadata = [
    ...
    entry('low_speed_takeover_time_s',P.brake.low_speed_takeover_time_s,'s','L2_7200','ENGINEERING_ASSUMPTION','medium','Fast friction-brake takeover while regenerative capability fades below the cutoff-high speed.');
    entry('stop_hold_entry_speed_mps',P.brake.stop_hold_entry_speed_mps,'m/s','L2_8100','ENGINEERING_ASSUMPTION','medium','Enter hold mode after the train reaches standstill; independent of absolute scenario time.');
    entry('hold_deceleration_mps2',P.brake.hold_deceleration_mps2,'m/s^2','L2_8100/L2_7200','ENGINEERING_ASSUMPTION','medium','Mechanical hold-brake equivalent request after standstill.');
