...
REGISTRY = WORK / "05_fmu/Rail_MBSE_FMU_Model_Registry_v2.json"
SSP_VALIDATION = WORK / "06_ssp/Executable_SSP_Validation_v2.json"
...
def run_case(scenario,dt,baseline,registry,suffix,raw=False):
    ...
    try:
        ...
        for k in range(int(round(STOP/dt))+1):
            ...
            fr=max(0.0,o("L2_8100","out_achieved_dynamic_brake_force")); fm=max(0.0,o("L2_7200","out_T_brake"))/WHEEL_RADIUS; fd=MASS*max(br,0.0)
            ...
            rows.append({"time":t,"scenario_phase":phase(t,v,br),"traction_command":tr,"service_brake_request":br,"v_train":v,"acceleration":0.0,
              ...
              "P_line":pline,"P_transformer_out":ptrans,"F_brake_demand":fd,"Fregen_actual":fr,"Fmechanical_actual":fm,"Ftotal_actual":fr+fm,
